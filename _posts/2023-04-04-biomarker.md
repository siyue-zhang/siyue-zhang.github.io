...
![](http://siyue-zhang.github.io/images/bio/logFC.png)

![](http://siyue-zhang.github.io/images/bio/vol.png)
...
![](http://siyue-zhang.github.io/images/bio/ont.png)

3. **Gene Set Enrichment Analysis (GSEA)**: I identify the significantly enriched pathways against KEGG pathways with a 0.05 p-value threshold. The function `gseKEGG` from `clusterProfiler` is used to perform GSEA. The `pathview` library is used to plot two enriched pathways: hsa03010 and hsa03040. (to be updated)

![](http://siyue-zhang.github.io/images/bio/path.png)

![](http://siyue-zhang.github.io/images/bio/hsa.png)
...
![](http://siyue-zhang.github.io/images/bio/tree.png)
