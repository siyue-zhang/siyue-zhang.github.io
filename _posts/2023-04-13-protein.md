...
This is the course project of NTU CE7412: Computational and Systems Biology by Professor Jagath Rajapakse. The full report is [here](). 

**Protein function prediction** is a key area of research in bioinformatics that involves the use of computational methods to predict the biological functions of proteins. It is an important field because understanding the function of proteins is essential for understanding cellular processes and disease mechanisms, as well as for the development of new drugs and therapies. 
